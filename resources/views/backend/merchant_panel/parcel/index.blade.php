                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if( $parcel->status == \App\Enums\ParcelStatus::DELIVERED)
                                            <a href="{{route('merchant-panel.parcel.logs',$parcel->id)}}" class="btn btn-sm btn-warning ml-1 " data-toggle="tooltip" data-placement="top" title="View">{{ __('View') }}</a>
                                        @endif
                                    </td>
                                </tr>
                                @endforeach
...
@push('scripts')
    ...
    <script src="{{ asset('backend/js/parcel/priorityChange.js') }}"></script>
